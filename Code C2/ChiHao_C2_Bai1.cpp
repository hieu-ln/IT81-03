//Khai bao, nhap, xuat, tim mot phan tu, them 1 phan tu vao cuoi, xoa phan tu vi tri i, tim mot phan tu va xoa trong danh sach
#include <iostream>
using namespace std;
...
//Tim mot phan tu trong danh sach, neu tim thay, xoa phan tu do
