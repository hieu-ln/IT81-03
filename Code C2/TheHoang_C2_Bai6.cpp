...
void chuyen10sang2(int a[] , int sp, int n)
{
int r,x;
while(n!=0)
{
	...
	do{
		...
		switch(choice)
		{
			...
			case 6:
				...
				break;
			case 7:
				cout<<"nhap so can chuyen " << endl;
				cin >> n;
				chuyen10sang2(a,sp,n);
				cout<<"stack sau khi chuyen " << endl;
				process_stack(a,sp);
				break;
